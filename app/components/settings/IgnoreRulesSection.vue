    ...
    <div class="mt-6 flex flex-col gap-6">
      ...
      <label class="flex items-center gap-3">
        ...
        <span>
          ...
          <span class="block text-sm text-night-400">Ignore push, schedule, and manual pipelines.</span>
        </span>
      </label>
      ...
      <label class="flex items-center gap-3">
        ...
        <span>
          ...
          <span class="block text-sm text-night-400">Off by default; cancels are usually noise.</span>
        </span>
      </label>
    </div>
  </section>
